function myFunction(xml,str) {
  ...
  for (i = 0; i <x.length; i++) {
    htmlList += "<div id='caja"+i+"' class='container'  style='border-botton:5px solid;'><div class='row'><div class='col-1'><img src='Icon/Twitter.png' alt='Icono Twitter' height='42' width='42'></div>"; 
